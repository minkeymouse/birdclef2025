% =====================================================================
% STATE NOTE (updated 2026-05-04):
% This file is the formal paper draft. It now covers:
%   - exp3-exp39, LB ladder v6-v12 (up to LB 0.929)
%   - The four-month plateau at v33 = LB 0.932 (Sec. \ref{sec:plateau})
%   - The public Mattia fork bringing LB to 0.941
%     (Sec. \ref{sec:mattia-fork})
%   - The Tucker SED training recipe: backbone distillation onto Perch
%     with stop-gradient (Sec. \ref{sec:tucker-recipe})
%   - Seven cognitive biases behind the plateau
%     (Sec. \ref{sec:meta-lessons})
%   - Forward plan for exp169 (Sec. \ref{sec:exp169-plan})
% Other reference files:
%   - paper/exp_current.tex   older running notes (stops near v36)
%   - CLAUDE.md "CURRENT STATE"  authoritative LB ladder + invariants
%   - experiments/README.md     code-side navigation
% Author TODO before CLEF 2026-06-17 working-note deadline: port the
% pseudo-label circular-distillation finding (v46), the AudioMAE
% foundation swap (v49/v50 -0.022/-0.027), and the synthetic-data
% domain-randomisation experiments (exp154-exp156).
% =====================================================================
